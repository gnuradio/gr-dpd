...
cx_fmat coeff = {{{0.9295, -0.0001}, {0.2939, 0.0005}, {-0.1270, 0.0034}, {0.0741, 0.0018}},  // 1st order coeffs
                ...
                {{0.1419, -0.0008}, {-0.0735, 0.0833}, {-0.0535, 0.0004}, {0.0908, -0.0473}},
                {{0.0084, -0.0569}, {-0.4610, 0.0274}, {-0.3011, -0.1403}, {-0.0623, -0.0269}}, // 5th order coeffs
                {{0.0084, -0.0569}, {-0.4610, 0.0274}, {-0.3011, -0.1403}, {-0.0623, -0.0269}},
...
namespace gr {
  namespace dpd {
    ...
    MP_model_PA::sptr
    MP_model_PA::make(int Order, int Mem_Depth)
    {
      return gnuradio::get_initial_sptr
        (new MP_model_PA_impl(Order, Mem_Depth));
    }
    ...
    void MP_model_PA_impl::gen_MP_vector(const gr_complex * in, int item, 
    int K_a, int L_a, cx_fcolvec &MP_vector)
    {
    ...
    int
    MP_model_PA_impl::work(int noutput_items,
