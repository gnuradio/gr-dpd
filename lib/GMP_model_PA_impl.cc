...
cx_fmat coeff1 = {{{0.9295, -0.0001}, {0.2939, 0.0005}, {-0.1270, 0.0034}, {0.0741, 0.0018}},  // 1st order coeffs
                {{0.8295, -0.0001}, {0.1939, 0.0005}, {-0.0270, 0.0014}, {0.0341, 0.0008}},
                {{0.1419, -0.0008}, {-0.0735, 0.0833}, {-0.0535, 0.0004}, {0.0908, -0.0473}}, // 3rd order coeffs
                {{0.0719, -0.0004}, {-0.0735, 0.0333}, {-0.0535, 0.0002}, {0.0908, -0.0273}},
                {{0.0084, -0.0569}, {-0.4610, 0.0274}, {-0.3011, -0.1403}, {-0.0623, -0.0269}}, // 5th order coeffs
                {{0.0044, -0.0369}, {-0.2610, 0.0174}, {-0.1511, -0.0703}, {-0.0323, -0.0169}},
                {{0.1774, 0.0265}, {0.0848, 0.0613}, {-0.0362, -0.0307}, {0.0415, 0.0429}}};   // 7th order coeffs
...
namespace gr {
  namespace dpd {
    ...
    GMP_model_PA::sptr
    GMP_model_PA::make(int model_param1, int model_param2, int model_param3, int model_param4, int model_param5)
    {
      return gnuradio::get_initial_sptr
        (new GMP_model_PA_impl(model_param1, model_param2, model_param3, model_param4, model_param5));
    }
     ...
     */
    GMP_model_PA_impl::GMP_model_PA_impl(int model_param1, int model_param2, int model_param3, int model_param4, int model_param5)
    ...
    void GMP_model_PA_impl::gen_GMP_vector(const gr_complex *const in, int item, 
    ...
    int
    GMP_model_PA_impl::work(int noutput_items,
