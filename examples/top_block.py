...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.dpd_gain_phase_calibrate_0, 1))
        ...
        self.connect((self.dpd_GMP_model_PA_0, 0), (self.qtgui_freq_sink_x_0, 0))
        ...
        self.connect((self.dpd_predistorter_training_0, 0), (self.dpd_RLS_postdistorter_0, 1))
